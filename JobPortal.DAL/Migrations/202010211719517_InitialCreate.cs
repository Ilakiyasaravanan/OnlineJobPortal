    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        CgpaId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.RecuiterDetailId)
                .ForeignKey("dbo.AccountDetails", t => t.AccountId, cascadeDelete: true)
                .ForeignKey("dbo.Cgpas", t => t.CgpaId, cascadeDelete: true)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.AccountDetails", t => t.AccountId, cascadeDelete: true)
                .ForeignKey("dbo.Cgpas", t => t.CGPA, cascadeDelete: true)
                .ForeignKey("dbo.JobTypes", t => t.JobTypeId, cascadeDelete: true)
                .Index(t => t.AccountId)
                .Index(t => t.JobTypeId)
                .Index(t => t.CGPA);
                ...
                p => new
                    {
                        ...
                        PhoneNumber = p.Long(),
                        Password = p.String(maxLength: 64),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SearcherJobDetails", "CGPA", "dbo.Cgpas");
            ...
            DropForeignKey("dbo.RecruiterJobDetails", "CgpaId", "dbo.Cgpas");
            ...
            DropIndex("dbo.SearcherJobDetails", new[] { "CGPA" });
            ...
            DropIndex("dbo.RecruiterJobDetails", new[] { "CgpaId" });
